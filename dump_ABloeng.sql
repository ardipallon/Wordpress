...
--
-- Host: localhost    Database: kristiin_Abloeng
-- ------------------------------------------------------
...
INSERT INTO `Employee` VALUES (1,'Jason','Martin','1996-07-25','2006-07-25',1234.56,'Toronto','Programmer'),(2,'Alison','Mathews','1976-03-21','1986-02-21',6661.78,'Vancouver','Tester'),(3,'James','Smith','1978-12-12','1990-03-15',6544.78,'Vancouver','Tester'),(4,'Celia','Rice','1982-10-24','1999-04-21',2344.78,'Vancouver','Manager'),(5,'Robert','Black','1984-01-15','1998-08-08',2334.78,'Vancouver','Tester'),(6,'Linda','Green','1987-07-30','1996-01-04',4322.78,'New York','Tester'),(7,'David','Larry','1990-12-31','1998-02-12',7897.78,'New York','Manager'),(8,'James','Cat','1996-09-17','2002-04-15',1232.78,'Vancouver','Tester');
/*!40000 ALTER TABLE `Employee` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `KASS`
--

DROP TABLE IF EXISTS `KASS`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `KASS` (
  `Kass_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `Nimi` varchar(50) NOT NULL,
  `Kaal_kg` float(3,1) NOT NULL,
  `Synniaasta` year(4) DEFAULT NULL,
...
--
-- Dumping data for table `KASS`
--

LOCK TABLES `KASS` WRITE;
/*!40000 ALTER TABLE `KASS` DISABLE KEYS */;
INSERT INTO `KASS` VALUES (1,'Miku',2.0,2007,'Tartu','I'),(2,'Miisu',1.5,2007,'Viljandi','E'),(3,'Muska',3.0,2005,'Viljandi','E'),(4,'Trull',4.5,2006,'Tartu','I'),(5,'Musti',2.0,2005,'Viljandi','I'),(6,'Triibu',3.5,2007,'Tartu','E'),(7,'Emma',5.0,2003,'Viljandi','E'),(8,'Miia',4.0,2006,'Viljandi','E');
/*!40000 ALTER TABLE `KASS` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2017-12-12 15:04:45
